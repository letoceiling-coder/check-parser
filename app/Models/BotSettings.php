...
class BotSettings extends Model
{
    ...
    public const DEFAULTS = [
        ...
        'msg_reservation_cancelled' => "⚠️ Ваша бронь снята администратором.\n\nВы можете снова забронировать места через бота (/start).",
        'msg_slots_available' => "🎉 Появились свободные места!\n\nЗаходите в бота и бронируйте участие (/start).",
    ];
